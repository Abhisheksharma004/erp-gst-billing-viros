  ...
  try {
    ...
    const [rows] = await db.execute(`
      SELECT
        ...
        document_number_separator as documentNumberSeparator,
        document_number_structure as documentNumberStructure,
    ...
    if (existing) {
      ...
      await db.execute(
        ...
        [
          ...
          data.challanPrefix,
          data.documentNumberSeparator || '/',
          data.documentNumberStructure || 'PREFIX_SERIAL_FY',
      ...
      await db.execute(
        `INSERT INTO business_settings (
          ...
          invoice_prefix, quotation_prefix, purchase_order_prefix, challan_prefix, document_number_separator, document_number_structure, terms_condition,
